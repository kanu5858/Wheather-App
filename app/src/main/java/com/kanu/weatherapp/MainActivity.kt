...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        permissionLauncher = registerForActivityResult(
            ...
            // In a real app, we'd check if permissions are granted
            // For this portfolio, we assume they are or handle the empty state in ViewModel
            // We'll trigger a dummy location for now or use the tracker
